<button onclick="sendEvent('select',{'item':{{ $id }}})">
    <div
        ...
        <span class="flex h-4 w-4">
            <span class="absolute bottom-2 right-2 transform translate-x-1/2 translate-y-1/2 inline-flex rounded-full h-4 w-4 bg-sky-700 text-xs text-white items-center justify-center">
                <div>
                {{ $quantity }}
                </div>
            </span>
