...
echo -e "\e[32mAll containers have been stopped.\e[0m"
...
echo -e "\e[32mAll volumes have been removed.\e[0m"

# Restart Docker
sudo docker compose down -v
echo -e "\e[32mDocker has been restarted.\e[0m"

# Remove all unused containers, networks, images (both dangling and unreferenced), and optionally, volumes.
sudo docker system prune -a -f
echo -e "\e[32mAll unused containers, networks, images, and volumes have been removed.\e[0m"
